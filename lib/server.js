...
Server.prototype.listen = function listen (port, host, server, cb){
  var me = this
  ...
  this.port >= 0 && this.socket.listen(this.port, this.host, function serverListening () {
